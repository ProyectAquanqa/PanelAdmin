      ...
      <div className="relative w-full p-0 m-0">
        ...
        >
          ...
          <div className="relative w-full h-full">
            ...
            {/* Título del menú - ahora se oculta completamente para evitar overflow */}
            <div 
              className={`absolute transition-opacity duration-150 whitespace-nowrap ${
        ...
        {/* Submenú - sin animación de altura, solo visibilidad inmediata */}
        {shouldExpand && item.submenu && isExpanded && (
          <ul className="w-full border-l-0 space-y-0 transition-opacity duration-100 p-0 m-0">
